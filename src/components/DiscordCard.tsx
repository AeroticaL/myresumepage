...
const DiscordCard = ({ section }) => {
	return (
		<motion.a
			href="https://discord.com/users/264852636375842816/"
			target="_blank"
			rel="noreferrer"
			...
			className="rounded-3xl bg-indigo-400 dark:bg-indigo-800 flex justify-center items-center col-span-1 relative aspect-square group"
		>
